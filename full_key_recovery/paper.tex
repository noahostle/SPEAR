...
for verification.  The proof-of-concept programs contain a local oracle; the
...
The proof of concept consists of two portable threaded C programs, one for the
last-stage prefix experiment and one for inward recovery.  Their shared cipher
core is a literal implementation of the reference operations.  Self-tests
...
The accompanying artifact contains the two C programs, the reference cipher
